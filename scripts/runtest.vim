...
let g:regopher_echo_command_info = 0
...
" Export root path to regopher dir.
let g:regopher_root = fnamemodify(getcwd(), ':p')
...
if s:fail > 0
  split /tmp/regopher-test/FAILED
  silent write
endif
...
silent! split /tmp/regopher-test/test.tmp
